...
//   { "-angle",  OPT_float,  &angle,  "Number of viewing degrees." },
//   { "-vangle", OPT_float,  &vangle, "Visual avoidance angle." },
//   { "-rcopy",  OPT_float,  &rcopy,  "Radius for copy vector." },
//   { "-rcent",  OPT_float,  &rcent,  "Radius for centroid vector." },
//   { "-rvoid",  OPT_float,  &rvoid,  "Radius for avoidance vector." },
//   { "-rviso",  OPT_float,  &rviso,  "Radius for visual avoidance vector." },
//   { "-wcopy",  OPT_float,  &wcopy,  "Weight for copy vector." },
//   { "-wcent",  OPT_float,  &wcent,  "Weight for centroid vector." },
//   { "-wvoid",  OPT_float,  &wvoid,  "Weight for avoidance vector." },
//   { "-wviso",  OPT_float,  &wviso,  "Weight for visual avoidance vector." },
//   { "-wrand",  OPT_float,  &wrand,  "Weight for random vector." },
//   { "-dt",     OPT_float,  &dt,     "Time-step increment." },
//   { "-ddt",    OPT_float,  &ddt,    "Momentum factor (0 < ddt < 1)." },
//   { "-minv",   OPT_float,  &minv,   "Minimum velocity." },
